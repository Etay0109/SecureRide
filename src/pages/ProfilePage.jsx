              ...
              {totalVehiclePages > 1 && (
                <div className="flex items-center justify-between mt-4">
                  <button
                    ...
                    className="px-4 py-2 rounded-xl border border-outline-variant/30 text-sm font-semibold text-on-surface disabled:opacity-40 hover:bg-surface-container transition-all"
                  >
                    Previous
                  </button>
        ...
        <section className="mb-10">
          ...
          {listings.length === 0 ? (
            <EmptyState
              ...
              description="Vehicles you list for sale will appear here."
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-3">
                    <div className="min-w-0">
                      <p className="font-bold text-on-surface text-sm truncate">
                        {l.vehicle_brand || "Unknown"} {l.vehicle_model || ""}
                      </p>
